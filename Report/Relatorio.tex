...
encontra o ficheiro \textit{Pós-Teste da Vaulted Pass.xlsx} e o ficheiro da avaliação exploratória do 
protótipo não funcional, \textit{Avaliação do Protótipo Não Funcional.xlsx}, com a pasta \textit{Vídeos} com os vídeos de 
cada utilizador a realizar os testes, e por fim o ficheiro onde cada utilizador informa o seu consentimento \textit{Consentimentos.xlsx}.
