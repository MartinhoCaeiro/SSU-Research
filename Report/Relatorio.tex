...
Foram realizados testes com um grupo de 10 utilizadores, com idades entre 22 e 30 anos, todos com alguma experiência em smartphones. Para 
cada participante foi explicado previamente o objetivo do teste e foi fornecido o guião de tarefas. Cada utilizador experimentou as quatro variantes 
do protótipo, e foram registados o tempo de execução, o número de erros e a preferência subjetiva.


\begin{table}[H]
\centering
% Opcional: Reduz ligeiramente o espaço entre colunas para garantir que cabe perfeitamente na página
...
o seu tempo de execução é mais rápido e dificulta a observação do PIN. 
...
Do ponto de vista do desenho, a principal conclusão é que segurança e usabilidade não são objetivos incompatíveis, mas exigem compromissos visíveis 
na interface. O protótipo permite agora avançar para uma avaliação com utilizadores, onde será possível confirmar qual das variantes oferece o melhor 
equilíbrio entre rapidez, memorização e proteção.
